                    ...
                    <table class="table">
                        ...
                        @forelse ($keke_users as $keke_user)
                          <tr>
                            ...
                            <td><button type="button" class="btn btn-primary"><a class="text-white" style="text-decoration: none" href="{{ url('/kekes/') }}/{{$keke_user->id}}/create" class="btn btn-default">Order Keke</a></button></td>
