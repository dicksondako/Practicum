                    ...
                    <table class="table">
                        ...
                        @forelse ($food_users as $food_user)
                          <tr>
                            ...
                            <td><button type="button" class="btn btn-primary"><a class="text-white" style="text-decoration: none" href="{{ url('/foods/') }}/{{$food_user->id}}/create" class="btn btn-default">Order Food</a></button></td>
